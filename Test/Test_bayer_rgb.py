...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_epoch',type=str,default='noise0_best')
    ...
    parser.add_argument('--decoder', type=str,
                        ...
                        default='myunet')  #原版default='unet'
    parser.add_argument('--shutter', type=str, default='bayerrgb') #quad 原版required=True, default='lsvpe'  default='rgbw'
    ...
    with torch.no_grad():
        ...
        # for (model_input, gt) in tqdm(test_dataloader):
            ...
            deblur ,cfa_img= model(input_rgb,train=False)
            ...
            #gt 保存路径
            save_gt_path='{:s}/gt/{:d}.png'.format(args.save_image_dir,save_image_index)
