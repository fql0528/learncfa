...
class ShuffleMixer(nn.Module):
    ...
    def __init__(self, n_feats=64, kernel_size=7, n_blocks=5, mlp_ratio=2, upscaling_factor=4):
        ...
        # self.to_feat = nn.Conv2d(3, n_feats, 3, 1, 1, bias=False) #原版
        self.to_feat = nn.Conv2d(4, n_feats, 3, 1, 1, bias=False)
        ...
        self.tail = nn.Conv2d(n_feats, 3, 3, 1, 1) #原版
...
if __name__ == '__main__':
    ...
    model = ShuffleMixer(n_feats=64, kernel_size=7, n_blocks=5, mlp_ratio=2, upscaling_factor=1)
